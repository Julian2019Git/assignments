...
*Antworten:*
  ...
  1. Ausgabe von Grafikdaten an den Bildschirm
  2. Kommunikation mit dem Speicher
  3. Durchführung von Berechnungen (Addition etc.)
  4. Status, der von anderen Teilen des Prozessors erzeugt wird
  5. Speicher für Zwischenergebnisse bei Berechnungen
  6. Verbindung zum Hauptspeicher
  7. Ausführung von Maschinenbefehlen
  8. Steuerung des Massenspeichers
  9. Speicher für den aktuell auszuführenden Befehl
  10. schneller Speicher, um Zugriffe auf das RAM zu minimieren
  11. Zähler für den auszuführenden Befehl
...
*Antworten:*
  ...
  1. Optische Datenträger
  2. SRAM
  3. Magnetische Datenträger
  4. SRAM oder DRAM
  5. DRAM
  6. Flash Speicherzellen
