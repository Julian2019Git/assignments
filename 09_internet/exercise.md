...
*Antworten:*
  ...
  4. Name der Seite, wird im Browserfenster angezeigt
  5. Daten zum Dokument, die nicht (direkt) angezeigt werden
  6. Umschließt die anzuzeigenden Daten
  7. Absatz
  8. Verweis auf ein anderes Dokument oder eine Stelle im Dokument
  9. Wurzelelement; umschließt das gesamte Dokument
  10. Zeilenumbruch
  11. Metadaten, z.B. Zeichensatz
